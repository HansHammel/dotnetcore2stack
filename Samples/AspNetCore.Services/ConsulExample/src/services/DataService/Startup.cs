...
namespace DataService
{
    public class Startup
    {
        ...
        {
            var config = Configuration.GetSection("ServiceDiscovery");
            ...
            services.AddSwaggerGen(opt =>
            {
                ...
                {
                    Title = config.GetSection("ServiceName").Value,
                    Version = config.GetSection("Version").Value,
                    Description = config.GetSection("Description").Value
                });
            });
